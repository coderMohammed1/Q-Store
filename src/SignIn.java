...
class Customer extends Users{
    ...
    public Customer(String uname,String fname,String lname, String ship,String age,String id) {
...
class Seller extends Users{
    ...
    public Seller(String uname,String fname,String lname,String age,String id) {
        super.UserName = uname;
        super.Fname = fname;
...
class Lquery{
    static final String URL = "jdbc:derby:oshop";
        ...
        Lquery(String uname, String passw){
            ...
            login = connect.prepareStatement("SELECT * FROM USERS WHERE USERNAME = ? AND PASSWORD_NEW = ? FETCH FIRST ROW ONLY" );
            }catch(Exception e){
                e.printStackTrace();
                System.exit(1);
            }
                     ...
                     while(result.next()){
                        ...
                        if(result.getString("UROLE").equals("c")){
                                ...
                                SignIn.cust = new Customer(result.getString("USERNAME"), result.getString("FIRST_NAME"),
                                        ...
                                        result.getString("AGE"),result.getString("ID"));
                                
                                JOptionPane.showMessageDialog(null, "Welcome! " + SignIn.cust.Fname ,"HI!",JOptionPane.INFORMATION_MESSAGE);
                                Products.caller3();
                            }else{
                             SignIn.sell = new Seller(result.getString("USERNAME"), result.getString("FIRST_NAME"),
                                ...
                                JOptionPane.showMessageDialog(null, "Welcome! " + SignIn.sell.Fname ,"HI!",JOptionPane.INFORMATION_MESSAGE);
                                Uploads.caller4();
                        }
